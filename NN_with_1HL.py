# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 19:02:14 2018
...
def backward_propagation(parameters, cache, X, Y):
    ...
    db1 = np.sum(dZ2,axis=1,keepdims=True) * (1 /  m)
    ### END CODE HERE ###
...
## It may take 1-2 minutes. You will observe different behaviors of the model for various hidden layer sizes.
